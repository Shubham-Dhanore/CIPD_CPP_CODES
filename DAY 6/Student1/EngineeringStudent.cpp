...
EngineeringStudent::EngineeringStudent(int r, std::string sname, int m[], int pracmarks, int projmarks) : Student(r, sname, m), practicalmarks(pracmarks), projectmarks(projmarks)
{
}
EngineeringStudent::~EngineeringStudent()
{
